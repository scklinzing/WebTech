		...
		<form action="../controllers/postCommentController.php" method="Post">
			<fieldset>
				...
				Nosh name: <input name="firstName" placeholder="Your nickname"
					...
					name="memberClassName" value="reader" required>Reader<br> <input
					type="radio" name="memberClassName" value="nosher">Nosher<br> <input
					type="radio" name="memberClassName" value="moderator">Moderator<br>
			</fieldset>
