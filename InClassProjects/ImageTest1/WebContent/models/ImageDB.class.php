<?php
// Responsibility: Handles uploads of images and other image handling
class ImageDB {
   
	public static function addImage($myImage) {
// 		// Inserts the user contained in a UserProfileData object into DB
// 		$query = "INSERT INTO IMAGES (userProfileEmail, userProfileFirstName, 
...
// 	}
	...
	public static function getImageArray($rowSets) {
// 		$userProfiles = array ();
